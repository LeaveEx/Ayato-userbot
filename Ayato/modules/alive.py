...
from Ayato.helpers.PyroHelpers import ReplyCheck
from Ayato.helpers.SQL.globals import gvarstatus
from Ayato.helpers.tools import convert_to_image
from Ayato.utils import get_readable_time
...
modules = CMD_HELP
alive_logo = (
    gvarstatus("ALIVE_LOGO") or "https://telegra.ph/file/da0f79694e2c3d44bdfa3.jpg"
)
emoji = gvarstatus("ALIVE_EMOJI") or "🐻‍❄️"
alive_text = gvarstatus("ALIVE_TEKS_CUSTOM") or "🐻‍❄️𝘗𝘙𝘌𝘔𝘐𝘜𝘔-BOT🐻‍❄️"
...
async def alive(client: Client, message: Message):
    ...
    man = (
        f"**🐻‍❄️ [KAMPANG-USERBOT](https://github.com/LeaveEx) 🐻‍❄️**\n\n"
        f"<b>{alive_text}</b>\n\n"
