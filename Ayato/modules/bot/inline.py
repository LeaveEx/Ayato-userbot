...
from Ayato.helpers.data import Data
from Ayato.helpers.inline import inline_wrapper, paginate_help
from config import BOT_VER, BRANCH as branch
from Ayato import CMD_HELP, StartTime, app
...
async def ping_function(message: Message, answers):
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Support", url="t.me/senzusupp")]]
            ),
        )
    )
    return answers
...
async def karman_function(message: Message, answers):
    msg = (
        f"🐻‍❄️KAMPANG-USERBOT🐻‍❄️ \n"
        "ㅤㅤStatus : 𝗦𝗨𝗣𝗘𝗥 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 \n"
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url="t.me/senzusupp"), InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url="t.me/itsmeleave")], [InlineKeyboardButton(text="ᴍᴇɴᴜ", callback_data="reopen")]]
            ),
        )
    )
    return answers
