...
from Ayato.helpers.misc import HAPP, XCB
from Ayato.helpers.tools import get_arg
from Ayato.utils.misc import restart
from Ayato.utils.pastebin import PasteBin
from Ayato.utils.tools import bash
...
async def upstream(client: Client, message: Message):
    ...
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            ...
            return
        await status.edit(
            "`[HEROKU]: Update Deploy KAMPANG-Userbot Sedang Dalam Proses...`"
        )
        ups_rem.fetch(ac_br)
...
add_command_help(
    "update",
    [
        ["update", "Untuk melihat list pembaruan terbaru dari   KAMPANG-Userbot."],
